...
public class PlotAxis implements Serializable {
	...
	private Integer max;
	/**
	 * a factor multiplied by the data range on the axis to give the axis range
	 * so that data points don't fall on the edges of the axis.
	 */
	private Double pad;
	/**
	 * a 1D [val1, val2, ...], or 2D [[val, label], [val, label], ...] array of
	 * ticks to use. Computed automatically.
	 */
